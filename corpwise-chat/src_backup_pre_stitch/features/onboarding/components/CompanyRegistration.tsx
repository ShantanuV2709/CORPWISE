...
import { adminSignup } from "../../auth/api/auth";
...
export function CompanyRegistration({ onRegistered, onBack, embedded = false }: CompanyRegistrationProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const data = await adminSignup(adminUsername, password, companyId, email, "starter");
    ...
    return (
        <div className={embedded ? "" : "auth-card"}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input
                    type="email"
                    placeholder="Organization Gmail (e.g. admin@gmail.com)"
                    value={email}
