            ...
            <div className="landing-container">
                ...
                <header className="landing-header">
                    ...
                    <div className="landing-header-actions">
                        <button className="glass-btn login-btn" onClick={() => openAuth('login')}>
                            Sign In
                        </button>
                        <CraftButtonDemo onClick={() => openAuth('register')}>
                            Get Started
                        </CraftButtonDemo>
                    </div>
                </header>
                ...
                <main className="landing-main">
                    ...
                    <section id="pricing" className="pricing-section" style={{ padding: '80px 40px', width: '100%', boxSizing: 'border-box' }}>
                        ...
                        {loadingTiers ? (
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', gap: '28px', justifyContent: 'center', alignItems: 'stretch', flexWrap: 'nowrap' }}>
                                {Object.entries(tiers).map(([tierId, tier]) => (
                                    <TierCard
                                        ...
                                        behindGlowColor={
                                            tierId === 'enterprise' ? 'rgba(255, 255, 255, 0.67)'
                                                : tierId === 'professional' ? 'rgba(16, 185, 129, 0.67)'
                    ...
                    <section className="bottom-cta-section">
                        ...
                        <div className="hero-ctas">
                            <ButtonIconHoverDemo onClick={() => openAuth('register')}>
                                Get Started
                            </ButtonIconHoverDemo>
                        </div>
