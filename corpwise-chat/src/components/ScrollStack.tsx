...
const ScrollStack = ({
    ...
    const updateCardTransforms = useCallback(() => {
        ...
        const endElement = useWindowScroll
            ...
            : scrollerRef.current?.querySelector('.scroll-stack-end') as HTMLElement | undefined;
    ...
    const setupLenis = useCallback(() => {
        if (useWindowScroll) {
            const container = document.querySelector('.landing-container') as HTMLElement;
            // If useWindowScroll is true, we rely on .landing-container for scrolling.
            // If it's not found, it's an unexpected state, so we assert its presence.
            if (!container) {
                console.error("'.landing-container' not found when useWindowScroll is true. Lenis will not be initialized.");
                return;
            }
            const lenis = new Lenis({
                wrapper: container, // Bind directly to .landing-container
